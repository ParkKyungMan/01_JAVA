...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        snum = 2;
        inum = 4;
        lnum = 8L; // 소문자 l을 써도 되지만, 숫자 1과 혼선 여부가 있어 대문자.

        /* 목차2. 2-2. 실수를 취급하는 자료형에 값 대입해보기  */
        fnum = 4.0f; // 대문자 f 를 써도 되지만, 소문자를 쓰느 ㄴ것이 일반적이다.
        dnum = 8.0; //

        /* 목차. 2-3. 문자를 췩브하는 자료형에 값 대입해보기 */
        ch = 'a'; // 문자는 '' 홑따옴표!!
